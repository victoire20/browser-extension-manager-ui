...
const Modal: React.FC<ModalProps> = ({ open, setOpen, item, onDelete }) => {
    const handleConfirm = () => {
        if (!item) return
        onDelete(item)
    }
                        ...
                        <div className="bg-white dark:bg-(--neutral-700) px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <DialogTitle
                                        as="h3"
                                        className="text-base font-semibold text-gray-900 dark:text-(--neutral-0)"
                                    >
                                        Extension removal
                                    </DialogTitle>

                                    <p className="mt-2 text-sm text-gray-500 dark:text-(--neutral-0) dark:opacity-70">
